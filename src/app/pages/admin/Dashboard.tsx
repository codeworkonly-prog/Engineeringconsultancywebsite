            ...
            <aside className="w-64 bg-white border-r flex flex-col">
                ...
                <nav className="flex-1 p-4">
                    <button
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg mb-2 ${activeSection === 'dashboard' ? 'bg-brand-50 text-brand-600' : 'text-gray-700 hover:bg-gray-50'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg mb-2 ${activeSection === 'projects' ? 'bg-brand-50 text-brand-600' : 'text-gray-700 hover:bg-gray-50'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg mb-2 ${activeSection === 'team' ? 'bg-brand-50 text-brand-600' : 'text-gray-700 hover:bg-gray-50'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg mb-2 ${activeSection === 'events' ? 'bg-brand-50 text-brand-600' : 'text-gray-700 hover:bg-gray-50'
                            }`}
                    >
